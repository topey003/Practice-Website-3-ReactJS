    ...
    <div className='featured'>
        ...
        <div className='container'>
          ...
          <div className='span-3 img-details'>
            <div className='top'>
              <h2>123 Cuayan Friendship, AC</h2>
              <p>House for Sale</p>
              <p className='price'>Php 8,000,000</p>
            </div>
            <div className='info-grid'>
              ...
              <div className='info'>
                <p className='bold'>Est Payment:</p><p>P45,000/mo</p>
              </div>
            </div>
          </div>
          <div className='span-2 right-img-details'>
              <p>A beautiful modern day home in the city with a full-size pool. Spacious and luxurious home located in Pampanga. Including media room, workout facility, and built-in sauna.</p>
        ...
        <div className='container'>
          ...
          <div className='span-3 img-details order-6'>
            <div className='top'>
              <h2>321 Mountain View Balibago, AC</h2>
              <p>House for Sale</p>
              <p className='price'>Php 10,000,000</p>
            </div>
            <div className='info-grid'>
              <div className='info'>
              ...
              <div className='info'>
                <p className='bold'>Square Feet:</p><p>11,200</p>
              </div>
              <div className='info'>
                <p className='bold'>Est Payment:</p><p>P60,000/mo</p>
              </div>
            </div>
          </div>
        </div>
